...
const languageCardCopy = {
  en: {
    ...
    german: { eyebrow: "Build structure and clarity in everyday moments.", themes: ["Precision", "Work", "Structure", "Conversation"] },
    italian: { eyebrow: "Make the rhythm of daily life feel natural.", themes: ["Music", "Travel", "Connection", "Culture"] },
  },
  es: {
    ...
    german: { eyebrow: "Construye claridad y estructura en la vida cotidiana.", themes: ["Precisión", "Trabajo", "Estructura", "Conversación"] },
    italian: { eyebrow: "Haz que el ritmo de la vida diaria se sienta natural.", themes: ["Música", "Viajes", "Conexión", "Cultura"] },
  },
  fr: {
    ...
    german: { eyebrow: "Construisez clarté et structure dans la vie quotidienne.", themes: ["Précision", "Travail", "Structure", "Conversation"] },
    italian: { eyebrow: "Rendez le rythme de la vie quotidienne naturel.", themes: ["Musique", "Voyage", "Connexion", "Culture"] },
  },
...
export function LanguageCard({ language }: { language: LanguageProfile }) {
  ...
  const c = copy[locale];
  const lc = languageCardCopy[locale][language.key];
  return (
