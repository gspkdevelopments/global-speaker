...
export default function LearnPage() {
  return (
    <>
      ...
      />
      <section className="section"><div className="container"><div className="language-card-grid">{activeLanguages.map((language) => <LanguageCard language={language} key={language.key} />)}</div></div></section>
